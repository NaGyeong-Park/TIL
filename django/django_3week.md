...
# SQLite는 기본적으로 id값 재사용 => 밑에 코드 id = 5
INSERT INTO classmates VALUES ('최전자', 28, '부산');
# id 재사용하지 않고 싶으면 : django 기본으로 사용되는 설정
CREATE TABLE 테이블이름 (
id INTEGER PRIMARY KEY AUTOINCREMENT, ...
);

# UPDATE : 기존행 데이터 수정 : 중복 불가능 값인 rowid 기준 수정하자!
...
![image-20220314134355738](django_3week.assets/image-20220314134355738.png)
